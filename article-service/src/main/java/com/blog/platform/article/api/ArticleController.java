...
public class ArticleController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<ArticleDto>> create(@Valid @RequestBody ArticleDto.Create request) {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<Page<ArticleDto>>> search(
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<ArticleDto>> update(@PathVariable UUID id, @Valid @RequestBody ArticleDto.Create request) {
